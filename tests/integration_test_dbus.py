...
class TestSnapperDBusIntegration(dbusmock.DBusTestCase):
    ...
    def setUp(self):
        ...
        self.dbusmock = dbus.Interface(
            self.get_dbus(True).get_object('org.opensuse.Snapper', '/org/opensuse/Snapper'), 
            dbusmock.MOCK_IFACE
        )
        self.dbusmock.AddMethod('org.opensuse.Snapper', 'CreateSingleSnapshot', 'ssss', 'i', 'ret = 100')
